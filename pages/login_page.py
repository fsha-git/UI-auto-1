...
class LoginPage(BasePage):
    ...
    def __init__(self, page: Page, base_url: str = "", locale: str = DEFAULT_LOCALE):
        ...
        self.username_input = page.get_by_role("textbox", name=t("usernameLabel", locale))
        self.password_input = page.get_by_role("textbox", name=t("passwordLabel", locale))
        self.login_btn = page.get_by_role("button", name=t("loginSubmit", locale))
